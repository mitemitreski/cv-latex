...
\item
	...
	\begin{itemize}
		...
		\resitem{Diploma thesis: Automatic parallelization in compilers and parallel programming languages}
...
\item {\bf Development:} 
	\begin{itemize}
	 ...
	 \resitem {{\bf Current technologies of choice include}} \\ 
	 	Java, JavaScript, Spring, Hibernate, Java EE stack, Node.js 
	 \resitem {{\bf Has basic work experience in}} \\ 
	 	 C\#, .NET, Pyhton2.x 
	 ...
	 \resitem{{\bf Regularly works with}}\\
	 	Bash, Zsh , Linux, HTML, Vim, Eclipse, Netbeans , Sublime Text
	\end{itemize}
...
\item
	...
	\begin{itemize}
      \resitem{ Work on Java based solutions mostly for the financial sector in Switzerland}
      \resitem{ Work on Intranet integration software}
	\end{itemize}

\item

	\ressubheading{Semos Edukacija }{Skopje, MK}{ Oracle Certified Java Trainer }{March 2010 - September 2013}
...
\item 
	...
	\resitem{Development of Java EE application for Ministry of Finance in Macedonia}
...
\item
	...
	\begin{itemize}
	\resitem{{\bf RoboMac 2010 } , \texttt{Robotic competition, organization, programming, fund-raising }}
	\resitem{{\bf RoboMac 2009 } , \texttt{Robotic competition, organization, programming, fund-raising }}
	\resitem{{\bf Hacklab KIKA } , \texttt{Participant in various programming related events}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{itemize}
    \resitem{{\bf HTML5 Data and Services Cookbook, Packtpub}, \texttt{Co-author of a book about HTML5 and JavaScript }}
	\end{itemize}
