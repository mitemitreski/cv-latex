...
\begin{itemize}
  ...
  \resitem {{\bf Software engineering}} \\ 
	 	Agile methodologies, Test Driven Development, Continuous Integration, Object-Oriented Design
  \resitem {{\bf Current technologies of choice include}} \\ 
	 	Java, JavaScript, Spring stack, Java EE stack, Node.js 
...
\item [] 
	...
	\begin{itemize}
      ...
      \resitem{ Mentored interns and new employees }
	\end{itemize}
